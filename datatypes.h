...
typedef enum {
	...
	CAN_PACKET_SET_RPM,
	CAN_PACKET_SET_POS,
	CAN_PACKET_SET_FAULT, // For EarthSense ESTOP
	...
	CAN_PACKET_ES_DETECT_APPLY_ALL_R_L, 			// For EarthSense Tuning App
	CAN_PACKET_ES_DETECT_APPLY_ALL_LINKAGE, 		// For EarthSense Tuning App
	CAN_PACKET_ES_DETECT_APPLY_ALL_HALL,			// For EarthSense Tuning App
	CAN_PACKET_ES_DETECT_APPLY_ALL_FOC_TUNING,	    // For EarthSense Tuning App
	CAN_PACKET_ES_SET_CURRENT_KP,					// For EarthSense Tuning App
	CAN_PACKET_ES_SET_CURRENT_KI,					// For EarthSense Tuning App
	CAN_PACKET_ES_SET_OBSERVER_GAIN,				// For EarthSense Tuning App
	CAN_PACKET_ES_ALL_MOTOR_PARAMETERS,				// For EarthSense Tuning App
